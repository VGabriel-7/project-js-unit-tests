...
describe('2 - Implemente os casos de teste para a função `numbers`', () => {
    it('Testa se numbers([1, 2, 3, 4, 5]) retorna true', () => {
      expect(numbers([1, 2, 3, 4, 5])).toBeTruthy();
    });
    // 
    it('Testa se numbers([1, 2, "3", 4, 5]) receber  retorna false', () => {
      expect(numbers([1, 2, '3', 4, 5])).toBeFalsy();
    });
    it('Testa se numbers([1, "a", 3]) receber  retorna false', () => {
      expect(numbers([[1, 'a', 3]])).toBeFalsy();
    });
    it('Testa se numbers([" "]) retorna false', () => {
